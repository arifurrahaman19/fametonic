		...
		<div className='mb-4'>
			<div className='container flex '>
				<div className='grow basis-0 mt-[22px]'>
					...
					<ul className='text-white text-base font-figtree font-semibold mt-4 space-y-2.5 leading-normal'>
					...
					<div className='flex flex-col justify-center items-center w-fit my-[28px]'>
						<button className='min-w-[313px] flex items-center justify-center cursor-pointer px-10 py-1.5 box-shadow-cyan font-figtree text-xl font-bold bg-[#FC004E] hover:bg-[#FC004E]/90 text-white rounded-[10px] uppercase'>
					...
					<p className='text-[#ABABAB] font-figtree text-[10px] font-medium leading-[normal] mt-3'>Fametonic 2025 ©All Rights Reserved.</p>
				</div>
				<div className='relative grow basis-0'>
					<div className='w-[666px] h-[679px] -top-[66px] -right-[114px] -z-10 flex items-center justify-center overflow-hidden absolute max-w-[unset]'>
